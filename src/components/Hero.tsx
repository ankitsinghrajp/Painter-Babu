...
const Hero = () => {
  ...
  return (
    <div className=" bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {/* Decorative Elements */}
      <div className="fixed top-20 right-8 animate-bounce hidden lg:block opacity-20 pointer-events-none z-10">
        <div className="w-16 h-16 bg-gradient-to-r from-orange-400 to-red-500 rounded-full"></div>
      </div>
      <div className="fixed bottom-20 left-8 animate-pulse hidden lg:block opacity-20 pointer-events-none z-10">
